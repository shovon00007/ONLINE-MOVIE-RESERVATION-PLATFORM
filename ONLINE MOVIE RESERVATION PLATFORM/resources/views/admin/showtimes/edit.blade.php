...
<div class="container">
    ...
    <form action="{{ route('admin.showtimes.update', $showtime->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="time" class="form-control" name="showtime" id="showtime" value="{{ $showtime->showtime }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="seat_capacity" id="seat_capacity" value="{{ $showtime->seat_capacity }}" required>
        </div>

        <div class="form-group">
            <label for="ticket_price">Ticket Price</label>
            <input type="number" step="0.01" class="form-control" name="ticket_price" id="ticket_price" value="{{ $showtime->ticket_price }}" required>
        </div>
